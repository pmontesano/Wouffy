...
export default function Landing() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
                Conectamos dueños responsables con paseadores profesionales y confiables.
                Tu mejor amigo merece los mejores paseos.
              </p>
      ...
      <section className="py-20 bg-[#F9FAFB]" data-testid="how-it-works-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
          ...
          <p className="text-center text-gray-600 mb-12 text-lg">Tres simples pasos para el mejor paseo</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Ingresá tu ubicación y descubrí paseadores profesionales en tu zona.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Seleccioná el horario que mejor te convenga y completá los detalles del paseo.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                El paseador acepta tu solicitud y tu mascota disfruta del mejor paseo.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white" data-testid="benefits-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 text-lg">Confianza y seguridad para tu mejor amigo</p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[#88D8B0] to-[#6FCF9F] rounded-3xl p-8 text-white" data-testid="benefit-1">
              <Shield size={40} className="mb-4" />
              <h3 className="text-xl font-bold mb-3" style={{ fontFamily: 'Outfit' }}>
                Paseadores Verificados
              </h3>
              <p className="opacity-90">
                Todos nuestros paseadores están verificados y cuentan con experiencia comprobada.
              </p>
            </div>

            <div className="bg-gradient-to-br from-[#FFCC99] to-[#FFBF80] rounded-3xl p-8 text-white" data-testid="benefit-2">
              <Star size={40} className="mb-4" />
              <h3 className="text-xl font-bold mb-3" style={{ fontFamily: 'Outfit' }}>
                Calificaciones Reales
              </h3>
              <p className="opacity-90">
                Lee opiniones de otros dueños y elige con confianza el mejor paseador.
              </p>
            </div>

            <div className="bg-gradient-to-br from-[#88D8B0] to-[#6FCF9F] rounded-3xl p-8 text-white" data-testid="benefit-3">
              <Clock size={40} className="mb-4" />
              <h3 className="text-xl font-bold mb-3" style={{ fontFamily: 'Outfit' }}>
                Flexibilidad Total
              </h3>
              <p className="opacity-90">
                Reservá paseos cuando lo necesites, con la duración que prefieras.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#F9FAFB]" data-testid="testimonials-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-3xl p-8 shadow-lg" data-testid="testimonial-1">
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={20} className="text-[#FFCC99]" fill="#FFCC99" />
                ))}
              </div>
              <p className="text-gray-700 mb-6">
                "Excelente servicio. María es una paseadora increíble y mi perro la adora. Totalmente recomendado."
              </p>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg" data-testid="testimonial-2">
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={20} className="text-[#FFCC99]" fill="#FFCC99" />
                ))}
              ...
              <p className="text-gray-700 mb-6">
                "La plataforma es muy fácil de usar y los paseadores son super responsables. Mi perra vuelve feliz de cada paseo."
              </p>
              <div className="flex items-center space-x-3">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg" data-testid="testimonial-3">
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={20} className="text-[#FFCC99]" fill="#FFCC99" />
                ))}
              ...
              <p className="text-gray-700 mb-6">
                "Como paseador, Wouffy me permitió conseguir clientes de forma rápida y segura. Excelente plataforma."
              </p>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-[#88D8B0] rounded-full flex items-center justify-center text-white font-bold">
                  CF
      ...
      <footer className="bg-[#1F2937] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                La forma más fácil y segura de encontrar paseadores para tu mascota.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/walkers" className="text-gray-400 hover:text-white transition-colors">
                    Buscar Paseadores
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>© 2025 Wouffy. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
